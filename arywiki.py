        ...
        if demonyms is not None:
            ...
            for d in demonyms:
                 if (d in self.get_main_content()):
                     ...
                     if "فرانساوي" in self.get_main_content():
                         self.updateCountryOfCitizenship("فرانساوي","فرنساوي")
                     if "برازيلي" in self.get_main_content():
                         self.updateCountryOfCitizenship("برازيلي","بريزيلي")
        else:
